...
Type
  ...
  Private
    ...
    // Tipo de Dato de la Clave recibida en el crear lista vacia
...
Begin
  ...
  Encontre := False;
  Q := Inicio;
  While (Q <> Nulo) And (Q <= Final) And Not(Encontre) Do
  Begin
...
Function Lista.LlenarClavesRandom(alSize: LongInt;
  RangoDesde, RangoHasta: LongInt): Errores;
Var
  X: TipoElemento;
Begin
